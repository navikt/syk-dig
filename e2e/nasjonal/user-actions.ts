        ...
        for (const periode of perioder) {
            ...
            if (periode.periodeType === '4.3 100% sykmelding') {
                ...
                await periodeSection
                    ...
                    .check()
                await periodeSection.getByLabel('Beskrivelse').nth(0).fill('Medisinsk beskrivelse') //Mangler?
                await periodeSection
                    .getByRole('checkbox', {
                ...
                await periodeSection
                    ...
                    .check()
                await periodeSection.getByLabel('Beskrivelse').nth(1).fill('Arbeidsrelatert beskrivelse') //Mangler?
            }
