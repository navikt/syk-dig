...
function SykmeldingSection({ id, title, children }: PropsWithChildren<Props>): ReactElement {
    return (
...
export function SykmeldingSectionSkeleton({ children }: PropsWithChildren<Omit<Props, 'id' | 'title'>>): ReactElement {
    return (
