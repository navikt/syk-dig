...
describe('Submit oppgave', async () => {
    ...
    it('Should be able to fill out and submit form', async () => {
        ...
        await userEvent.type(gradertPeriodeSection.getByLabelText('F.o.m'), '010120')
        await userEvent.type(gradertPeriodeSection.getByLabelText('T.o.m'), '030120')
        await userEvent.click(
        ...
        await userEvent.type(vanligPeriodeSection.getByLabelText('F.o.m'), '010120')
        await userEvent.type(vanligPeriodeSection.getByLabelText('T.o.m'), '030120')
